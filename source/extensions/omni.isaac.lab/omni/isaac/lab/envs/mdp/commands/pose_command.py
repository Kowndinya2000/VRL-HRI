...
class UniformPoseCommand(CommandTerm):
    ...
    def __init__(self, cfg: UniformPoseCommandCfg, env: ManagerBasedEnv):
        ...
        # print("----****[test_differential_ik.py][DEBUG@KOWNDI]: robot: ", type(self.robot))
        print("----****[test_differential_ik.py][DEBUG@KOWNDI]: # robot joints: ", self.robot.num_joints)
        print("----****[test_differential_ik.py][DEBUG@KOWNDI]: # robot bodies: ", self.robot.num_bodies)
        print("----****[test_differential_ik.py][DEBUG@KOWNDI]: robot bodies: ", self.robot.body_names)
        print("----****[test_differential_ik.py][DEBUG@KOWNDI]: robot joints: ", self.robot.joint_names)        
        # print("----****[test_differential_ik.py][DEBUG@KOWNDI]: robot bodies: ", self.robot.find_bodies(cfg.body_name))
